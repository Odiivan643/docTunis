...
<div class="container mx-auto py-4 px-4">
    <h1 class="text-3xl font-bold mb-4 text-red-600">Vendredi 11</h1>
    <p class="text-gray-500 mb-8">Voici notre programme pour ce vendredi.</p>
    <div class="grid grid-cols-5 gap-3">
    @foreach ($vendredi as $film)
